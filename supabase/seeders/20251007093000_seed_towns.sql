-- Seed towns idempotently, ensuring county_id maps to existing counties (1..47 alphabetical)
BEGIN;

-- Helper: upsert town only if (name, county_id) not exists
-- Using ON CONFLICT on (name, county_id) unique constraint
